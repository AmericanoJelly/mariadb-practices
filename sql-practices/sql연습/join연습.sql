...
select a.emp_no, concat(a.first_name,a.last_name) 이름, b.title 
	from employees a, titles b
    where  a.emp_no = b.emp_no		-- join 조건(n-1)
    and b.title  = 'engineer'		-- row 선택조건
    and  a.gender ='f';
...
-- 실습문제 1:   현재 회사 상황을 반영한 직원별 근무부서를 사번, 직원 전체이름, 근무부서 형태로 출력
